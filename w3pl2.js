...
//დავაკვირდეთ ბოლო ხაზზე რაც გვიწერია კონსოლში. თუ i არც 5ზე იყოდა და არც 3ზე, მაშინ output ისევ ცარიელი სტრინგი ანუ "" იქნება და  console.log(output && i ); დააბრუნებს ""ს, იმიტომ რომ ცარიელი სტრინგი არის falsy. თუ რომელიმეზე ან ორივეზე იყოფა, მაშინ outputის მნიშვნელობა შეიცვლება და გახდება "Fizz", "Buzz" ან "FizzBuzz" - ნებისმიერ შემთხვევაში truthy მნიშვნელობა ექნება. ასევთივე მნიშვნელობა ექნება iსაც, იმიტომ რომ ჩვეულებრივი რიცხვია, თუმცა console.log(output && i)  დააბრუნებს iს იმიტომ რომ ორივე truthy არის და ბრუნდება ბოლო ელემენტი 🔥 ❤️ 
